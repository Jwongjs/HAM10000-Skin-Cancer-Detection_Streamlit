...
def download_and_load_model():
    """Download model from cloud storage and load it"""
    
    # Replace with actual cloud storage direct download URL
    model_url = "https://drive.google.com/file/d/15LBP6awUDjMOQFftsVC1GxA6kpi-4Yj0/view?usp=sharing"  # Google Drive, Dropbox, etc.
    model_dir = Path("model")
    model_path = model_dir / "phase2_best.pth"
    ...
    return load_model_local(str(model_path))
